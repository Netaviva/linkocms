 ...
 */
class Page_Ajax extends Linko_Ajax
{
    public function setHomepage()
    {
        ...
        if(Linko::Model('Page/Action')->setHomepage($iId))
        {
            $this->toJson(array(
                'page_id' => $iId,
            ));
    ...
    public function updateBlockOrder()
    {
        ...
        Linko::Model('Page/Action')->updateBlockOrder($aBlockOrder);
    ...
    public function getBlockForm()
    {
        ...
        $this->output(Linko::Module()->getBlock('page/admincp/block-form', array(
    ...
    public function deleteBlock()
    {
        ...
        if(Linko::Model('Page/Block/Action')->deleteBlock($iBlockId))
        {
            return $this->toJson(array(
                'success' => true,
    ...
    public function assignBlock()
    {
        ...
        if(count($aPost))
        {
            ...
            if(Linko::Validate()->isValid($aPost))
            {
                ...
                if($iPageBlockId = Linko::Model('Page/Block/Action')->assignBlock($iPageId, array(
                ...
                {
                    $aBlock = Linko::Model('Page/Block')->getPageBlock($iPageBlockId);
    ...
    public function updateBlock()
    {
        ...
        if(count($aPost))
        {
            ...
            if(Linko::Validate()->isValid($aPost))
            {
                ...
                if(Linko::Model('Page/Block/Action')->updateBlock($iBlockId, array(
                    'title' => $sTitle,
                    'param' => $aParam,
                    'dissallow_access' => $aPost['dissallow_access']
                )))
                {
                    $aBlock = Linko::Model('Page/Block')->getPageBlock($iBlockId);
